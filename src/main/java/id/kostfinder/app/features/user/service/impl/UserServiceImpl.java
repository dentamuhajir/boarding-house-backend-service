...
import id.kostfinder.app.features.user.dto.response.UserDetailResponseDTO;
import id.kostfinder.app.features.user.dto.response.UserListResponseDTO;
import id.kostfinder.app.features.user.model.EndUser;
import id.kostfinder.app.features.user.model.User;
import id.kostfinder.app.features.user.repository.EndUserRepository;
import id.kostfinder.app.features.user.repository.UserRepository;
